...
public class BoundBinaryOperator implements BoundExpression {
    ...
    private static BoundBinaryOperator[] operators = {
            ...
            new BoundBinaryOperator(OpType.SUB, BoundBinaryOperation.SUBTRACTION, TypeSymbol.CHAR, TypeSymbol.INT, TypeSymbol.CHAR),
            ...
            new BoundBinaryOperator(OpType.EQ, BoundBinaryOperation.EQUALS, TypeSymbol.CHAR, TypeSymbol.CHAR, TypeSymbol.BOOL),
...
//            new BoundBinaryOperator(OpType.EQ, BoundBinaryOperation.EQUALS, TypeSymbol.REAL, TypeSymbol.INT, TypeSymbol.BOOL),
            ...
            new BoundBinaryOperator(OpType.NEQ, BoundBinaryOperation.NOT_EQUALS, TypeSymbol.CHAR, TypeSymbol.CHAR, TypeSymbol.BOOL),
